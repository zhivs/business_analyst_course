...
1. Спроектировать РБД Системы интерактивного обучения в 3 Н.Ф.  (до 5 сущностей)
...
- Выборка с применением встроенных операторов (<>, BETWEEN, LIKE, IN, ...) (минимум 3 запроса)
