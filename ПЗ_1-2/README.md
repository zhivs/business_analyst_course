...
2. С какими специалистами аналитик взаимодействует чаще всего?
...
1. Что такое жизненный цикл ПО и зачем понимание его процессов системному аналитику?
...
### Методики Agile для управления командой
...
## 🎓 Интерактивное задание: Запуск платформы
...
Платформа должна позволять: 
    ...
    - Участвовать в мини-играх и квизах для закрепления материала (геймификация).
    - Общаться с наставником и получать персональные рекомендации.
    - Отслеживать прогресс и получать достижения.
 ```    

Сейчас у компании есть идея, бренд и первые наработки, но нет единой системы. Есть отдельные Google-документы, видео на RuTube и тесты в Excel. Пользователи теряются, прогресс не отслеживается, а поддержка работает вручную. 
...
|----------------------|----------------|------------------------------|--------------------------|
| Системный аналитик   | +  | анализ + поддержка                              |                          |
| Product Manager      |   +            | все этапы |                          |
| Frontend-разработчик х1 |+ | разработка                               |                          |
| Backend-разработчик  х3| +                | разработка                              |                          |
| QA-инженер           |      +         | тестирование                              |                          |
| DevOps / SRE         |      +         |                              |                          |
| UX/UI-дизайнер       |      +         |                              |                          |
| Архитектор ПО        |       +           | Проектирование                              |                          |
