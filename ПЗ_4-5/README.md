...
|---------------------|---------|---------------------|
| API Gateway → User Service | HTTP | 'GET /users/me' - получить профиль авторизованного пользователя|
...
Опишите все шаги, когда студент:
1. Открывает задание.
...
1. **Архитектура**  
   Спроектируйте архитектуру монолитного приложения для системы интерактивного обучения. Укажите все компоненты (UI, backend, БД, аутентификация) и сравните с микросервисной архитектурой из занятия.
